...
`;
		...
		function MarketPanel(props) {
			...
			return (0, react.createElement)("div", { className: "mkts" }, toast ? (0, react.createElement)("div", { className: "mkts-err" }, toast) : null, data.notice ? (0, react.createElement)("div", { className: "mkts-notice" }, data.notice) : null, embedded ? null : envInfo ? (0, react.createElement)("div", { className: "mkts-env" + (envReady ? "" : " mkts-env-bad") }, t("envLine") + ": DSH_HOME " + (envInfo.dshHome ? "✓ " + envInfo.dshHome : "✗") + " · node " + (envInfo.node ? "✓" : "✗") + " · dsh " + (binOk ? "✓" : "✗") + (!envInfo.dshBin && !(envInfo.binProvided && envInfo.binValid) ? " — dsh CLI 未定位" : "")) : null, embedded ? null : (0, react.createElement)("div", { className: "mkts-bin-row" }, (0, react.createElement)("input", {
