window.__ModuleLoader__.load({
	id: "dsh-webui-market-plugin-plus",
	factory: (require) => {
		var module = { exports: {} };
...
`;
		...
		function isActive(plugin, installedMap) {
			...
			return (state.bundles || []).some((b) => norm(b) === needle);
		}
		function GlobalProgress() {
			...
			return (0, react.createElement)("div", { className: "mkts mkts-prog" }, needRestart ? (0, react.createElement)("div", { className: "mkts-restart" }, (0, react.createElement)("span", { style: { flex: 1 } }, t("restartBanner")), (0, react.createElement)("span", { style: {
				fontSize: 11,
				color: "var(--dsw-static-deepseek-500)"
			} }, t("restartHint"))) : null, (0, react.createElement)("div", {
		...
		function MarketPanel() {
			...
			const loadInstalled = (plugins) => {
				...
				Promise.all(profiles.map((profile) => apiOp("installed", { profile }).then((r) => [profile, r]).catch(() => [profile, null]))).then((entries) => setData((d) => ({
					...d,
			...
			(0, react.useEffect)(() => {
				...
				apiOp("list", { lang: LOCALE }).then(finish).catch((e) => {
					...
					setData((d) => ({
						...d,
						phase: "error",
						error: t("fetchFail") + ": " + String(e && e.message || e)
					}));
				});
				return () => {
					alive = false;
			...
			const toggle = (p, active) => {
				...
				apiOp("toggleActive", {
					...
					if (r && r.ok) {
						setData((d) => ({
							...d,
							toast: r.error ? r.error : r.needsRestart ? t("restartBanner") : r.active ? t("activeLive") : t("inactiveLive")
						}));
						loadInstalled();
					} else setData((d) => ({
						...d,
			...
			const sorted = sortBy === "hot" ? [...filtered].sort((a, b) => (b.stars ?? -1) - (a.stars ?? -1)) : sortBy === "new" ? [...filtered].sort((a, b) => String(b.added || "").localeCompare(String(a.added || ""))) : filtered;
			let groups = [];
			if (cat === "all" && !showInstalled) for (const c of data.cats || []) {
			...
			}), (0, react.createElement)("span", null, LOCALE === "zh" ? "跳过安全检查（来源白名单 + 试装验证，风险自负：可能装坏 web 启动）" : "Skip safety checks (source whitelist + trial boot; risky: may break web boot)")) : null) : null, op.phase === "starting" ? (0, react.createElement)("div", { className: "mkts-cmdrow" }, (0, react.createElement)("span", { className: "mkts-spin" }), (0, react.createElement)("span", { style: { fontSize: 12 } }, op.kind === "install" && op.profile === "web" && !op.skipCheck ? t("probing") : t("submit"))) : null, op.phase === "running" ? (0, react.createElement)("div", null, (0, react.createElement)("div", { className: "mkts-cmdrow" }, (0, react.createElement)("span", { className: "mkts-spin" }), (0, react.createElement)("span", { style: { fontSize: 12 } }, t("running") + " · " + fmt("elapsed", {
				s: Math.round((op.elapsedMs || 0) / 1e3),
			...
			return (0, react.createElement)("div", { className: "mkts" }, toast ? (0, react.createElement)("div", { className: "mkts-err" }, toast) : null, envInfo ? (0, react.createElement)("div", { className: "mkts-env" + (envReady ? "" : " mkts-env-bad") }, t("envLine") + ": DSH_HOME " + (envInfo.dshHome ? "✓ " + envInfo.dshHome : "✗") + " · node " + (envInfo.node ? "✓" : "✗") + " · dsh " + (binOk ? "✓" : "✗") + (!envInfo.dshBin && !(envInfo.binProvided && envInfo.binValid) ? " — dsh CLI 未定位" : "")) : null, (0, react.createElement)("div", { className: "mkts-bin-row" }, (0, react.createElement)("input", {
				...
				href: LOCALE === "zh" ? "https://awesome-dsh-plugin.com/zh/" : "https://awesome-dsh-plugin.com/",
				target: "_blank",
				rel: "noopener noreferrer"
			}, LOCALE === "zh" ? "https://awesome-dsh-plugin.com/zh/" : "https://awesome-dsh-plugin.com/"), (0, react.createElement)("span", null, " ↗")), modal, (0, react.createElement)("div", { className: "mkts-finder" }, (0, react.createElement)("div", { className: "mkts-row1" }, (0, react.createElement)("input", {
				className: "mkts-search",
				placeholder: t("search"),
				value: query,
				onChange: (e) => setQuery(e.target.value)
			}), liveChip, (0, react.createElement)("span", { className: "mkts-count" }, filtered.length + " / " + (data.plugins || []).length)), (0, react.createElement)("div", { className: "mkts-chips" }, (data.cats || []).map((c) => (0, react.createElement)("button", {
				key: c.id,
			...
			}, c.id === "all" ? t("all") : c.label, " ", (0, react.createElement)("small", null, c.count))), (0, react.createElement)("button", {
				className: "mkts-chip" + (showInstalled ? " mkts-chip-on" : ""),
				onClick: () => {
					setShowInstalled(!showInstalled);
					setCat("all");
				}
			}, t("instFilter"), " ", (0, react.createElement)("small", null, installedCount)), (0, react.createElement)("div", { className: "mkts-sort" }, [
				...
				return (0, react.createElement)("div", {
					...
					target: "_blank",
					rel: "noopener noreferrer"
				}, t("gh"))), p.desc ? (0, react.createElement)("p", { className: "mkts-desc" }, p.desc) : null, isOpen ? (0, react.createElement)("div", { className: "mkts-detail" }, (0, react.createElement)("div", null, t("cmdLabel")), (0, react.createElement)("code", null, p.cmd || t("noCmd")), (0, react.createElement)("div", { className: "mkts-hint" }, t("hint"))) : null), (0, react.createElement)("div", { className: "mkts-actions" }, (0, react.createElement)("span", { className: "mkts-state " + (inst ? active ? "mkts-state-on" : "mkts-state-inactive" : "mkts-state-off") }, inst ? active ? t("active") : t("inactive") : t("noActive")), (0, react.createElement)("button", {
					className: "mkts-cmdbtn",
			...
			}))) : null, data.phase === "ready" && filtered.length === 0 ? (0, react.createElement)("div", { className: "mkts-hint" }, t("noMatch")) : null);
		}
		const inject = ["slots"];
		function apply(ctx) {
