...
`;
		...
		function MarketPanel() {
			...
			return (0, react.createElement)("div", { className: "mkts" }, toast ? (0, react.createElement)("div", { className: "mkts-err" }, toast) : null, data.notice ? (0, react.createElement)("div", { className: "mkts-notice" }, data.notice) : null, envInfo ? (0, react.createElement)("div", { className: "mkts-env" + (envReady ? "" : " mkts-env-bad") }, t("envLine") + ": DSH_HOME " + (envInfo.dshHome ? "✓ " + envInfo.dshHome : "✗") + " · node " + (envInfo.node ? "✓" : "✗") + " · dsh " + (binOk ? "✓" : "✗") + (!envInfo.dshBin && !(envInfo.binProvided && envInfo.binValid) ? " — dsh CLI 未定位" : "")) : null, (0, react.createElement)("div", { className: "mkts-bin-row" }, (0, react.createElement)("input", {
			...
			}), liveChip, (0, react.createElement)("span", { className: "mkts-count" }, showInstalled ? filtered.length + " " + t("instFilter") : fmt("totalResults", { n: totalCount }))), (0, react.createElement)("div", { className: "mkts-chips" }, (0, react.createElement)("button", {
		...
		function MarketOnboarding(props) {
			...
			}, t("done"))), (0, react.createElement)("div", { className: "mkts-ob-body" }, (0, react.createElement)(MarketPanel))));
		}
		const inject = ["slots"];
		function apply(ctx) {
