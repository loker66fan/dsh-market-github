...
`;
		...
		function MarketPanel(props) {
			...
			return (0, react.createElement)("div", {
				className: "mkts",
				ref: topRef
			}, toast ? (0, react.createElement)("div", { className: "mkts-err" }, toast) : null, data.self && data.self.updateAvailable ? (0, react.createElement)("div", { className: "mkts-selfupdate" }, (0, react.createElement)("span", { style: { flex: 1 } }, fmt("selfUpdate", {
		...
		function InstalledPanel() {
			...
			const toggle = (row) => {
				...
				apiOp("toggleActive", {
					...
					if (r && r.ok) {
						setData((d) => ({
							...d,
							toast: r.needsRestart ? t("restartBanner") : r.active ? t("activeLive") : t("inactiveLive")
						}));
						load();
					} else setData((d) => ({
						...d,
			...
			return (0, react.createElement)("div", { className: "mkts" }, data.toast ? (0, react.createElement)("div", { className: "mkts-err" }, data.toast) : null, data.self && data.self.updateAvailable ? (0, react.createElement)("div", { className: "mkts-selfupdate" }, (0, react.createElement)("span", { style: { flex: 1 } }, fmt("selfUpdate", {
				cur: data.self.version,
				latest: data.self.latestVersion
			})), (0, react.createElement)("button", {
				className: "mkts-cmdbtn mkts-cmdbtn-primary",
				...
				key: p.name,
				className: "mkts-item"
			}, (0, react.createElement)("div", { className: "mkts-main" }, (0, react.createElement)("h3", null, p.name, p.version ? (0, react.createElement)("span", { className: "mkts-by" }, "v" + p.version) : null, p.updateAvailable ? (0, react.createElement)("span", { className: "mkts-state mkts-state-inactive" }, t("updTo").replace("{latest}", String(p.latestVersion ?? "?"))) : null), p.spec ? (0, react.createElement)("div", { className: "mkts-meta" }, (0, react.createElement)("span", null, t("specNote") + ": " + String(p.spec))) : null), (0, react.createElement)("div", { className: "mkts-actions" }, (0, react.createElement)("span", { className: "mkts-state " + (p.enabled ? "mkts-state-on" : "mkts-state-inactive") }, p.enabled ? t("active") : t("inactive")), (0, react.createElement)("button", {
			...
			}, (0, react.createElement)("span", null, p.name), (0, react.createElement)("span", { className: "mkts-by" }, p.version ? "v" + p.version : ""))) : null) : null);
		}
		const inject = ["slots"];
