...
`;
		...
		function MarketPanel(props) {
			...
			return (0, react.createElement)("div", { className: "mkts" }, toast ? (0, react.createElement)("div", { className: "mkts-err" }, toast) : null, data.self && data.self.updateAvailable ? (0, react.createElement)("div", { className: "mkts-selfupdate" }, (0, react.createElement)("span", { style: { flex: 1 } }, fmt("selfUpdate", {
		...
		function InstalledPanel() {
			...
			return (0, react.createElement)("div", { className: "mkts" }, data.self && data.self.updateAvailable ? (0, react.createElement)("div", { className: "mkts-selfupdate" }, (0, react.createElement)("span", { style: { flex: 1 } }, fmt("selfUpdate", {
				cur: data.self.version,
				latest: data.self.latestVersion
			})), (0, react.createElement)("button", {
				className: "mkts-cmdbtn mkts-cmdbtn-primary",
